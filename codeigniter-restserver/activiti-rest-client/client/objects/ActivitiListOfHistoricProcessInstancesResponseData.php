...
require_once(__DIR__ . '/ActivitiListOfHistoricProcessInstancesResponseDataVariable.php');
	

class ActivitiListOfHistoricProcessInstancesResponseData extends ActivitiResponseObject
{
	/* (non-PHPdoc)
	...
	/**
	 * @var array<ActivitiListOfHistoricProcessInstancesResponseDataVariable>
	 */
	protected $variables;
	...
	/**
	 * @return array<ActivitiListOfHistoricProcessInstancesResponseDataVariable>
	 */

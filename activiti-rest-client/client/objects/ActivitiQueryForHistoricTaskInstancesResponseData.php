...
require_once(__DIR__ . '/ActivitiQueryForHistoricTaskInstancesResponseDataTaskVariable.php');
require_once(__DIR__ . '/ActivitiQueryForHistoricTaskInstancesResponseDataProcessVariable.php');
	

class ActivitiQueryForHistoricTaskInstancesResponseData extends ActivitiResponseObject
{
	/* (non-PHPdoc)
	...
	protected function getAttributes()
	{
		return array_merge(parent::getAttributes(), array(
			...
			'parentTaskId' => '',
			'url' => 'string',
			'taskVariables' => 'array<ActivitiQueryForHistoricTaskInstancesResponseDataTaskVariable>',
			'processVariables' => 'array<ActivitiQueryForHistoricTaskInstancesResponseDataProcessVariable>',
			'tenantId' => 'string',
		));
	}
	...
	/**
	 * @var array<ActivitiQueryForHistoricTaskInstancesResponseDataTaskVariable>
	 */
	protected $taskVariables;

	/**
	 * @var array<ActivitiQueryForHistoricTaskInstancesResponseDataProcessVariable>
	 */
	...
	/**
	 * @return array<ActivitiQueryForHistoricTaskInstancesResponseDataTaskVariable>
	 */
	...
	/**
	 * @return array<ActivitiQueryForHistoricTaskInstancesResponseDataProcessVariable>
	 */
